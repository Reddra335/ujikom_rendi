...
// Ambil parameter filter dari GET: tahun, bulan, tanggal, status bayar
...
// Ambil data untuk pencarian client-side (opsional)
$allData = [];
$sql_all = "SELECT 
              p.PenjualanID, 
              p.invoice, 
...
<head>
    ...
    * {
    ...
    /* Desain tombol konfirmasi pembayaran */
    .btn-konfirmasi {
        display: inline-block;
        padding: 10px 20px;
...
<body>
    ...
    // Listener pencarian realtime (opsional)
