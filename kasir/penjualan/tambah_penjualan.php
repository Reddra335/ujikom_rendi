...
<body>
    ...
    function updateRow(el) {
        ...
        if (select.value !== "") {
            ...
            // Jika jumlah melebihi stok, tampilkan popup dan beri tanda merah
            if (jumlah > stok) {
                Swal.fire({
                    icon: "warning",
                ...
                jumlah = stok;
                // Beri tanda merah pada input jumlah
                jumlahInput.style.border = "2px solid red";
            } else {
                // Hapus style border merah apabila input valid
                jumlahInput.style.border = "";
            }
            ...
            // Hapus tanda merah bila tidak ada produk yang dipilih
            jumlahInput.style.border = "";
        }
        calculateTotal();
    }
