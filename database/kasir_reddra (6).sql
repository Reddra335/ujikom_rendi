...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Apr 2025 pada 03.26
...
(84, 96, 40, 5, 1, 1000, 0, 1000),
(85, 97, 40, 5, 1, 1000, 0, 1000);
...
(95, '2025-04-14 06:53:05', '2025-04-14 06:53:05', 41, 'dibayar', 'INV1744588385', '0.00', '0.00', '2025-04-14 06:53:05'),
...
(40, 'pc', '1000.00', 95, 12, '', 'uploads/1744535016_elvis.jpg'),
(69, '11', '11.00', 9, 18, '10', '11'),
(70, 'tv', '2000.00', 1000, 24, '1000', 'uploads/1744537573_dreamy.png'),
(71, 'pc', '11.00', 11, 18, 'ee', 'uploads/1744537627_annisha.jpg'),
(72, 'vga', '100000.00', 5000, 22, 'ajbasjhfhbfHHFB', 'uploads/1744537673_logo pkg.png');
...
--
ALTER TABLE `detailpenjualan`
  MODIFY `DetailID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `penjualan`
  MODIFY `PenjualanID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
